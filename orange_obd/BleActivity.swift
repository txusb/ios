...
class BleActivity: UIViewController,CBCentralManagerDelegate, CBPeripheralDelegate {
    enum SendDataError: Error {
        case CharacteristicNotFound
    }
    var ScannerChange:UIViewController!
    ...
    func GoScanner(_ page:UIViewController){
        ScannerChange=page
    ...
    func SwipePage(to newViewController: UIViewController){
    ...
    func RX(){}
    func TX(_ data:String){}
    func LoadIng(_ a:String){
